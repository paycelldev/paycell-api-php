...
include '../model/getTermsOfServiceContentRequest.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if(isset($data["webCallMethod"]) && $data["webCallMethod"] == "REST"){
        echo post(RestEndpointConstants::$getTermsOfServiceContent, $request);
    } else {
        echo json_encode(soap(SoapEndpointConstants::$provisionServices, "getTermsOfServiceContent", $request));
    }
}
