...
include '../model/provisionRequest.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $request = new ProvisionRequest(null, $header, 
    ...
    if(isset($data["webCallMethod"]) && $data["webCallMethod"] == "REST"){
        $resp = json_decode(post(RestEndpointConstants::$provision, $request));
    } else {
        $resp = soap(SoapEndpointConstants::$provisionServices, "provision", $request);
    }
